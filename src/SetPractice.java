...
public class SetPractice {
	...
	public static void setExplorer( ) {
		...
		addAll(set, "cat","dog","elephant","bird","ant");
		...
		addAll(set2, "cat","dog","elephant","bird","ant");
		...
		Set<String> TreeComp = new TreeSet<String>(new Comparator<String>(){
		...
		addAll(TreeComp, "cat","dog","elephant","bird","ant");
		
		
		
		System.out.println("Add duplicate items to the set ");
		TreeComp.add(new String("cat"));
		TreeComp.add(new String("dog"));
